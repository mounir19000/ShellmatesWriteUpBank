...
const removeMarkdownMetadata = (markdownContent)=>{
    ...
    while(startIndex < lines.length){
        ...
        if (line && line.match(/^\*\*(Category|Event|Difficulty|Date|Author):\*\*/)) {
            startIndex++;
        } else if (line === "") {
...
*Want to contribute? Learn how to [submit a writeup](/HowToSubmit).*`);
                    ...
                    setContent(`*Error loading writeup content. Please try again later.*`);
                }
            } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__3f5c37a5._.js.map